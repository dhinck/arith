...
# Modified from previous comp 40 makefiles
# October 21, 2017
...
40image: 40image.o compress40.o uarray2.o a2plain.o compress.o\
	 RGB_CV_Transforms.o ManipulateWordElements.o Quantizing.o \
	 ModifyWordPack.o bitpack.o decompress.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
